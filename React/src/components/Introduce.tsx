    ...
    return (
        <IntroContainer>
            <div>
                ...
                저는 알바와 일용직을 전전하며 일을 하다가 단순히 앉아서 일을 하고 싶은 욕구가 너무 강해 일을 알아보다,<br/>
                우연히 국비 지원 교육을 통해 2021년 3월에 IT를 접하게 되었고,<br/>
                ...
                개발과 배포 등 전반적인 IT 업무를 하는 전문적인 모습을 보며 동경하게 되었고,<br/>
                점점 IT 지식에 대한 학구열이 불타기 시작했습니다.<br/><br/>
                그에 대한 근거로 2021년 6월부터 2022년 6월까지 자격증을 6개 취득하였습니다.<br/>
